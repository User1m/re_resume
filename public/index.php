...
<head>
  ...
  <script src="js/jquery.queryloader2.min.js" type="text/javascript" async></script>
  <!-- <script src="js/load.js" type="text/javascript" async></script> -->

  <!-- combined/minifed of the above -->
...
<body>
  ...
  <div class="wrapper" id="wrapper">
                ...
                <div class="container">
                  ...
                  <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="menuItem"><a href="#skills">Skills</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class=" col-xs-12 col-sm-12 col-md-7 col-lg-7">
            <h3>Claudius Mbemba</h3>
            <h4 class="subHeading"><em>Adventure addict, Life learner, World traveler,<br/>
                Entrepreneur, & Developer residing in Seattle WA</em></h4>
            <p>After graduating HS in the top of my class, I accepted an offer letter to The Ohio State University, where I'd
              ...
              <br/><br/>Division I collegiate football was a full-time job in and of its own. Having to balance a tough academic
              schedule & rigorous practice schedule, all the while working (I worked as a technology assistant) to pay for
              housing and my next meal (scholarship only covered tuition) meant I was just getting by in my classes.
              <br/><br/>During my two-and-a-half year colligate football career, I suffered 2 major injuries, 1 of which
              was limb threatening (<b><a href="https://g.co/kgs/cLsJG9" target="blank">compartment syndrome</a></b>). It
              was after the 2nd major injury that I ultimately decided to move on from the sport and focus on my Bachelors.
              Moving on from football left me with plenty of time on my hands and so I sought to fill it by founding & leading
              student orgs, finding my passion for and participating in numerous hackathons, and ultimately starting 2 companies.
              <br/><br/><b><a href="https://youtu.be/BrMm6IEd6K8" target="blank">FUNDSTARTER LLC</a></b>, my first social-entrepreneurial
              venture, was founded in 2012-13. The concept of crowdfunding was just hitting its peak; spearheaded by companies
              like Kickstarter. We were the "Kickstarter for non-profits". Using the crowdfunding model, with a twist (raffle
              auctioning), donors could give to causes they cared about and potentially win once-in-a-lifetime experiences
              (an early competitor in the space was
              <b><a href="https://www.omaze.com/">omaze.com</a></b>). Fundstarter was successful for a year but then the
              realities of a startup ran solely by college students who weren't dropping out of college resulted in the slow
              but sure death of the business.
              <br/><br/>From that failure I gained a lot of knowledge, which I brought along to my 2nd venture. In 2014-15,
              as a result of an independent study for my entrepreneurship minor, 4 close developer friends (including my
              former manager) and I founded <b>AppKitchen</b> to build mobile applications for small & medium businesses
              (SMBs) on a budget.
              <br/><br/>As CEO, I did a lot of business development and project pipeline building. But in summer of ’15,
              I took an internship at Microsoft to learn best-practices of developing enterprise software. This resulted
              in a full-time offer from Microsoft and me subsequently stepping down as CEO from AppKitchen. AppKitchen has
              since gone on to do amazing work building mobile apps.
    ...
    <section class="education" id="education">
      <div class="container">
        <div class="heading">
          ...
          <p>My academic career thus far</p>
        </div>
        <div class="row workDetails">
          <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
            <div class="workYear">Graduated<br>Dec, 2015</div>
          </div>
          <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
            ...
            <div class="exCon">
              ...
              <p>I completed my Bachelor's from The Ohio State University, where I studied Computer Science with a minor in
                Spanish and a strong focus on Entrepreneurship. I held numerous leadership position on campus that ranged
                from varsity sports to entrepreneurship and development; even founding a student organization focused on
                building entrepreneurial students.</p>
            </div>
          </div>
        </div>
        <div class="row workDetails">
          <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
            <div class="workYear">Ongoing</div>
          </div>
          <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
            <div class="arrowpart"></div>
            <div class="exCon">
              <h4>Software Engineering Development</h4>
              <h5>University of the Web</h5>
              <p>From Lynda to Udemy, I’ve taken my education beyond the walls of the typical classroom and constantly look
                online to improve my knowledge of different programming languages, web, and mobile technologies such as PHP,
                ROR, HTML, CSS, JS, Objective-C. I’ve gained a wealth of knowledge on my own and continue to look to the
                web to learn new programming skills and languages.</p>
            </div>
          </div>
        </div>
        <div class="row workDetails">
          <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
            <div class="workYear">Graduated<br> Jun, 2011</div>
          </div>
          <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
            <div class="arrowpart"></div>
            <div class="exCon">
              <h4>High School Diploma</h4>
              <h5>Olentangy High School</h5>
              <p>I’m an alumni of Olentangy High School in Lewis Center, OH. There I studied multiple disciplines with a focus
                in Math, Science, History, Psychology, and English. In addition I played varsity football, was 2 time Track
                and Field Captain as well as a school record holder in discus. I was VP of the school’s largest student organization
                that focused on service within the community, and I participated in a host of student orgs such as the National
                Honor Society. I graduated in the top 5% of my class with high honors including Summa Cum Laude.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row workDetails">
          ...
          <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
            ...
            <div class="exCon">
              <h4><a href="https://www.microsoft.com/" target="blank">Microsoft</a></h4>
              <h5><em>Software Development Engineer</em></h5>
    ...
    <section class="skills" id="skills">
      <div class="container">
        <div class="heading">
          ...
          <p>Some things I can say I’m getting good at…</p>
        </div>
        <div class="row">
          <!-- skills -->
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              <h4>PHP / MySQL</h4>
              <div class="progress progress-striped active">
                <div class="progress-bar progress-bar-skills" style="width: 80%;">
                  <span class="sr-only">80% Complete</span>
                </div>
              </div>
              <p>Building production ready web apps with database layers.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Constant use in my web development.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              <h4>Java</h4>
              <div class="progress progress-striped active">
                <div class="progress-bar progress-bar-skills" style="width: 85%;">
                  <span class="sr-only">85% Complete</span>
                </div>
              </div>
              <p>Have built and launched Android apps.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              <h4>Ruby on Rails</h4>
              <div class="progress progress-striped active">
                <div class="progress-bar progress-bar-skills" style="width: 90%;">
                  <span class="sr-only">90% Complete</span>
                </div>
              </div>
              <p>Building ROR web apps with DB capabilities.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Currently using jQuery in web apps, S.P.As, and AJAX.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Have built and shipped IOS applications.</p>
            </div>
          </div>
        </div>
        <!-- skills -->
        ...
        <div class="row">
          ...
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              <h4>Ambition</h4>
              <div class="progress progress-striped active">
                <div class="progress-bar progress-bar-skills" style="width: 100%;">
                  <span class="sr-only">100% Complete</span>
                </div>
              </div>
              <p>High achiever and a goal setter and getter.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              <h4>COMMUNICATION</h4>
              <div class="progress progress-striped active">
                <div class="progress-bar progress-bar-skills" style="width: 95%;">
                  <span class="sr-only">95% Complete</span>
                </div>
              </div>
              <p>Strong communication and speaking skills.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Able to take a concept and extrapolate.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Hold a number of leadership positions in my community / work</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Can effectively delegate while contributing to a team effort.</p>
            </div>
          </div>
          <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 skillsArea">
            <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 skills">
              ...
              <p>Love to work in diverse groups and collaborate with other team members.</p>
            </div>
          </div>
        </div>
        <!-- management -->
    ...
    <section class="activities" id="activities">
      <div class="container">
        <div class="heading">
          <h2>Activities</h2>
          <p>A showcase of the things I dabble in</p>
        </div>
        <div class="activitiesFilter">
          <ul>
            <li><a href="#" data-filter="*" class="current">All</a></li>
            <li><a href="#" data-filter=".org">Organizations</a></li>
            <li><a href="#" data-filter=".hack">Developer</a></li>
            <li><a href="#" data-filter=".eship">Entrepreneurship</a></li>
          </ul>
        </div>
    ...
    <section class="contact" id="contact">
      ...
      <!--  <div class="row mapArea">
          <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://mapsengine.google.com/map/u/0/embed?mid=zc_TUhnMts2w.kw4uw1_P6cB4&amp;t=m&amp;z=16&amp;output=embed"></iframe>
        </div> -->
    </section>
    <section class="contactDetails">
      <div class="container">
        ...
        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
          ...
          <p> <i class="fa fa-map-marker fa-lg"></i> Seattle WA</p>
          <p> <i class="fa fa-mobile fa-lg"></i> <a href="tel:7406410248">+740 641 0248</a></p>
          <p> <i class="fa fa-envelope-o "></i> <a href="mailto:claudius@claudiusmbemba.com">claudius@claudiusmbemba.com</a></p>
          <p> <i class="fa fa-link "></i> www.claudiusmbemba.com</p>
        </div>
        <!--contact info end-->
        <!--contact form start-->
        <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 conForm">
          ...
          <!-- <form method="post" action="php/contact.php" name="cform" id="cform"> -->
            ...
            <input type="submit" onclick="mailer()" id="submit" name="send" class="submitBtn" value="Send message">
    ...
    <section class="footer" id="footer">
      <div class="container">
        <ul>
          <li><a href="https://twitter.com/mbembaships" target="blank"><i class="fa fa-twitter fa-2x"></i></a></li>
          <li><a href="https://www.facebook.com/mbembac" target="blank"><i class="fa fa-facebook fa-2x"></i></a></li>
          <li><a href="https://www.linkedin.com/in/mbembac" target="blank"><i class="fa fa-linkedin fa-2x"></i></a></li>
          <li><a href="https://github.com/user1m" target="blank"><i class="fa fa-github fa-2x"></i></a></li>
          <li><a href="https://devpost.com/User1m" target="blank"><i class="fa fa-code fa-2x"></i></a></li>
          <li><a href="https://medium.com/@mbembaships" target="blank"><i class="fa fa-pencil fa-2x"></i></a></li>
        </ul>
      </div>
    </section>
    <!--footer end-->
  ...
  <script>
        function mailer() {
            const subscriber = $('#subscribeEmail').val();
